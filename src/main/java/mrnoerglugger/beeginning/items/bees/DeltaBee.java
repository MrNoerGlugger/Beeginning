...
public class DeltaBee {
    ...
    public static final Item DELTA_PRINCESS = new BeeItem(new FabricItemSettings().maxCount(1).group(BEE_GROUP));
    public static final Item DELTA_DRONE = new BeeItem(new FabricItemSettings().group(BEE_GROUP));
    public static final Item DELTA_QUEEN = new BeeItem(new FabricItemSettings().maxCount(1).group(BEE_GROUP).maxDamage(2000));
