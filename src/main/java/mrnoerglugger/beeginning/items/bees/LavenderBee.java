...
public class LavenderBee {
    ...
    public static final Item LAVENDER_PRINCESS = new Item(new FabricItemSettings().maxCount(1).group(BEE_GROUP));
    public static final Item LAVENDER_DRONE = new Item(new FabricItemSettings().group(BEE_GROUP));
    public static final Item LAVENDER_QUEEN = new Item(new FabricItemSettings().maxCount(1).group(BEE_GROUP).maxDamage(2000));
