...
public class MarigoldBee {
    ...
    public static final Item MARIGOLD_PRINCESS = new Item(new FabricItemSettings().maxCount(1).group(BEE_GROUP));
    public static final Item MARIGOLD_DRONE = new Item(new FabricItemSettings().group(BEE_GROUP));
    public static final Item MARIGOLD_QUEEN = new Item(new FabricItemSettings().maxCount(1).group(BEE_GROUP).maxDamage(2000));
