...
public class SantolinaBee {
    ...
    public static final Item SANTOLINA_PRINCESS = new BeeItem(new FabricItemSettings().maxCount(1).group(BEE_GROUP));
    public static final Item SANTOLINA_DRONE = new BeeItem(new FabricItemSettings().group(BEE_GROUP));
    public static final Item SANTOLINA_QUEEN = new BeeItem(new FabricItemSettings().maxCount(1).group(BEE_GROUP).maxDamage(2000));
