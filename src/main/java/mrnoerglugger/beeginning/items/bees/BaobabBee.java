...
public class BaobabBee {
    ...
    public static final Item BAOBAB_PRINCESS = new BeeItem(new FabricItemSettings().maxCount(1).group(BEE_GROUP));
    public static final Item BAOBAB_DRONE = new BeeItem(new FabricItemSettings().group(BEE_GROUP));
    public static final Item BAOBAB_QUEEN = new BeeItem(new FabricItemSettings().maxCount(1).group(BEE_GROUP).maxDamage(2000));
