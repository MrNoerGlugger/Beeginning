...
public class GerberaDaisyBee {
    ...
    public static final Item GERBERA_DAISY_PRINCESS = new Item(new FabricItemSettings().maxCount(1).group(BEE_GROUP));
    public static final Item GERBERA_DAISY_DRONE = new Item(new FabricItemSettings().group(BEE_GROUP));
    public static final Item GERBERA_DAISY_QUEEN = new Item(new FabricItemSettings().maxCount(1).group(BEE_GROUP).maxDamage(2000));
