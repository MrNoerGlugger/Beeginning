...
public class ExtraordinaryBee {
    ...
    public static final Item EXTRAORDINARY_PRINCESS = new Item(new FabricItemSettings().maxCount(1).group(BEE_GROUP));
    public static final Item EXTRAORDINARY_DRONE = new Item(new FabricItemSettings().group(BEE_GROUP));
    public static final Item EXTRAORDINARY_QUEEN = new Item(new FabricItemSettings().maxCount(1).group(BEE_GROUP).maxDamage(2000));
