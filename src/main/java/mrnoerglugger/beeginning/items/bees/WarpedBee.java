...
public class WarpedBee {
    ...
    public static final Item WARPED_PRINCESS = new BeeItem(new FabricItemSettings().maxCount(1).group(BEE_GROUP));
    public static final Item WARPED_DRONE = new BeeItem(new FabricItemSettings().group(BEE_GROUP));
    public static final Item WARPED_QUEEN = new BeeItem(new FabricItemSettings().maxCount(1).group(BEE_GROUP).maxDamage(2000));
