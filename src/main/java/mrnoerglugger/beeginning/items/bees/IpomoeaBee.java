...
public class IpomoeaBee {
    ...
    public static final Item IPOMOEA_PRINCESS = new Item(new FabricItemSettings().maxCount(1).group(BEE_GROUP));
    public static final Item IPOMOEA_DRONE = new Item(new FabricItemSettings().group(BEE_GROUP));
    public static final Item IPOMOEA_QUEEN = new Item(new FabricItemSettings().maxCount(1).group(BEE_GROUP).maxDamage(2000));
