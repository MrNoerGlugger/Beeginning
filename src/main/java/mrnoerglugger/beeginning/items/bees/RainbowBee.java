...
public class RainbowBee {
    ...
    public static final Item RAINBOW_PRINCESS = new Item(new FabricItemSettings().maxCount(1).group(BEE_GROUP));
    public static final Item RAINBOW_DRONE = new Item(new FabricItemSettings().group(BEE_GROUP));
    public static final Item RAINBOW_QUEEN = new Item(new FabricItemSettings().maxCount(1).group(BEE_GROUP).maxDamage(2000));
