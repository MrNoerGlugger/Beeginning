...
public class PlainBee {
    ...
    public static final Item PLAIN_PRINCESS = new BeeItem(new FabricItemSettings().maxCount(1).group(BEE_GROUP));
    public static final Item PLAIN_DRONE = new BeeItem(new FabricItemSettings().group(BEE_GROUP));
    public static final Item PLAIN_QUEEN = new BeeItem(new FabricItemSettings().maxCount(1).group(BEE_GROUP).maxDamage(2000));
