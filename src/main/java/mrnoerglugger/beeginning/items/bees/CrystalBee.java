...
public class CrystalBee {
    ...
    public static final Item CRYSTAL_PRINCESS = new BeeItem(new FabricItemSettings().maxCount(1).group(BEE_GROUP));
    public static final Item CRYSTAL_DRONE = new BeeItem(new FabricItemSettings().group(BEE_GROUP));
    public static final Item CRYSTAL_QUEEN = new BeeItem(new FabricItemSettings().maxCount(1).group(BEE_GROUP).maxDamage(2000));
