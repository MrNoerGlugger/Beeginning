...
public class CarboBee {
    ...
    public static final Item CARBO_PRINCESS = new BeeItem(new FabricItemSettings().maxCount(1).group(BEE_GROUP));
    public static final Item CARBO_DRONE = new BeeItem(new FabricItemSettings().group(BEE_GROUP));
    public static final Item CARBO_QUEEN = new BeeItem(new FabricItemSettings().maxCount(1).group(BEE_GROUP).maxDamage(2000));
