...
public class QueenOfTheNightTulipBee {
    ...
    public static final Item QUEEN_OF_THE_NIGHT_TULIP_PRINCESS = new BeeItem(new FabricItemSettings().maxCount(1).group(BEE_GROUP));
    public static final Item QUEEN_OF_THE_NIGHT_TULIP_DRONE = new BeeItem(new FabricItemSettings().group(BEE_GROUP));
    public static final Item QUEEN_OF_THE_NIGHT_TULIP_QUEEN = new BeeItem(new FabricItemSettings().maxCount(1).group(BEE_GROUP).maxDamage(2000));
