...
public class LazuriteBee {
    ...
    public static final Item LAZURITE_PRINCESS = new BeeItem(new FabricItemSettings().maxCount(1).group(BEE_GROUP));
    public static final Item LAZURITE_DRONE = new BeeItem(new FabricItemSettings().group(BEE_GROUP));
    public static final Item LAZURITE_QUEEN = new BeeItem(new FabricItemSettings().maxCount(1).group(BEE_GROUP).maxDamage(2000));
