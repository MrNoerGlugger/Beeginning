...
public class LazuriteBee {
    ...
    static Item item3 = Items.LAPIS_ORE;
    static Item item4 = Items.DEEPSLATE_LAPIS_ORE;
    public static final DefaultedList<ItemStack> LazuriteOutput = DefaultedList.ofSize(2, ItemStack.EMPTY);
    public static final DefaultedList<ItemStack> LazuriteCombOutput = DefaultedList.ofSize(2, ItemStack.EMPTY);
    ...
    public static void registerLazuriteBee() {
        ...
        LazuriteCombOutput.set(0, new ItemStack(item3));
        LazuriteCombOutput.set(1, new ItemStack(item4));
    }
}
