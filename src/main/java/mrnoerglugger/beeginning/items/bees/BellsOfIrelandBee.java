...
public class BellsOfIrelandBee {
    ...
    public static final Item BELLS_OF_IRELAND_PRINCESS = new Item(new FabricItemSettings().maxCount(1).group(BEE_GROUP));
    public static final Item BELLS_OF_IRELAND_DRONE = new Item(new FabricItemSettings().group(BEE_GROUP));
    public static final Item BELLS_OF_IRELAND_QUEEN = new Item(new FabricItemSettings().maxCount(1).group(BEE_GROUP).maxDamage(2000));
