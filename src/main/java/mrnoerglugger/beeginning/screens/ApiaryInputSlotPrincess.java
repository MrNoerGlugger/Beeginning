...
public class ApiaryInputSlotPrincess extends Slot {
    private final ApiaryScreenHandler handler;

    public ApiaryInputSlotPrincess(ApiaryScreenHandler apiaryScreenHandler, Inventory inventory, int i, int j, int k) {
        super(inventory, i, j, k);
        this.handler = apiaryScreenHandler;
    }

    public static boolean checkByTags(ItemStack stack){
        Tag<Item> tags = ItemTags.PRINCESSES;
        boolean found = false;
