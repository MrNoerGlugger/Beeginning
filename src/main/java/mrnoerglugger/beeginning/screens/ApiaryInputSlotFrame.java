...
public class ApiaryInputSlotFrame extends Slot {
    private final ApiaryScreenHandler handler;

    public ApiaryInputSlotFrame(ApiaryScreenHandler apiaryScreenHandler, Inventory inventory, int i, int j, int k) {
        super(inventory, i, j, k);
        this.handler = apiaryScreenHandler;
    }

    public static boolean checkByTags(ItemStack stack){
        Tag<Item> tags = ItemTags.BEE_FRAMES;
        boolean found = false;
