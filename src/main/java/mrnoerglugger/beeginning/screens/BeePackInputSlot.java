...
public class BeePackInputSlot extends Slot {
    private final BeePackScreenHandler handler;

    public BeePackInputSlot(BeePackScreenHandler beePackScreenHandler, Inventory inventory, int i, int j, int k) {
        super(inventory, i, j, k);
        this.handler = beePackScreenHandler;
    }
